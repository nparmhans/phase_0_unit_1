	...
	$.extend(Selectbox.prototype, {
		...
		_attachSelectbox: function (target, settings) {
			...
			$target.children().each(function(i) {
				...
				if (that.is("option")) {getOptions(that);} else if (that.is("optgroup")) {
					li = $("<li>");
					$("<span>", {
			...
			sbHolder.data("uid", inst.uid).bind("keydown.sb", function (e) {
				...
				e.stopPropagation();
				return false;
			}).delegate("a", "mouseover", function (e) {$(this).addClass(inst.settings.classFocus);}).delegate("a", "mouseout", function (e) {$(this).removeClass(inst.settings.classFocus);});
			...
			$([".", inst.settings.classHolder, ", .", inst.settings.classSelector].join("")).mousedown(function(e) {e.stopPropagation();});
		},
		/**
